...
<template>
 <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        <div class="sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            <h2 class="mt-5 text-center text-2xl/9 font-bold tracking-tight text-gray-900 dark:text-white">Sign in to your account</h2>
        </div>
            ...
            <form class="space-y-6" action="#" method="POST">
                ...
                <div class="text-gray-900 dark:text-white ">
                    ...
                    <div class="mt-2">
                        ...
                        <RouterLink class="font-semibold  text-sm text-indigo-600 dark:text-indigo-300 hover:text-indigo-500 " :to="{ name: 'register' }">Forgot your password?</RouterLink>
                        </div>
                </div>
                <div>
                    <Button type="button" class="w-full mb-3" @click="login">Sign In</Button>
                    <Button class="w-full dark:text-white dark:bg-gray-800 dark:border-gray-400" variant="outline" @click="cancel">Cancel</Button>
                </div>
                <div class="text-sm">
                    <p class="font-semibold inline dark:text-white">Not a member?&nbsp;</p><RouterLink class="font-semibold text-indigo-600 dark:text-indigo-300 hover:text-indigo-500" :to="{ name: 'register' }">Register here!</RouterLink>
                 </div>
            </form>
        </div>
    </div>
